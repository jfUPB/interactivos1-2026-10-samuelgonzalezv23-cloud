...
### Actividad 4
El programa no funciona con was_pressed porque was_pressed solo se vuelve verdadera en el frame en el que el botón es presionado y no con en los frames siguientes aunque el botón se mantenga presionado. Esto resulta en que el cuadrado solo cambie de color por un frame y luego vuelva a ser verde, lo cual es imperceptible.
